...
#define     RANGE_DISTANCE           800  //80 CM
#define     RANGE_LEAFT_TIME         2000  //2s  人走灯灭
#define     RANGE_DETECT_TIME        200  //
...
#define MOTO_DEBOUNCE			50    //10MS 到达中点
...
#define LOCK_ZERO_01_PIN             GPIO_Pin_4
#define LOCK_ZERO_02_PIN             GPIO_Pin_5
...
{
    RANGE_STATE_INIT = 0,  //
    RANGE_STATE_DEBOUNCE,
    RANGE_STATE_WAIT_LEAFT,
    RANGE_STATE_DEF = 0XFF,
}Range_State_T;   
