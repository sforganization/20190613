...
//	{CM1,TT/4},{CL5,TT/4},{CM1,TT/4},{0,TT/4},
    ...
    {0, 10},{0xFFFF, 0xFFFF},   //结束标识 
};


static vu8 g_toneIndex = 0;
...
//	SysTask.BeepState = BEEP_STATE_INIT;
//    

//    if(SysTask.u16BeepWaitTime != 0)
//        return;
//    
//	BeepSound(AllBGM[g_toneIndex].mName, 3);
//    SysTask.u16BeepWaitTime = AllBGM[g_toneIndex].mTime;
//	g_toneIndex++;

//    if((AllBGM[g_toneIndex].mTime == 0xFFFF) && (AllBGM[g_toneIndex].mName == 0xFFFF))
//    {
//        SysTask.u16BeepWaitTime = 50;
//        g_toneIndex = 0;
//    }
}
