...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(fileIsExists(filePath + fileName))
        {
            Log.e("error:", "loginfo  密码文件存在");
        }else{
            Log.e("error:", "loginfo  密码文件不存在！！");
       ...
       input_08_Button = findViewById(R.id.passwd_digit_08);
        ...
        erase = findViewById(R.id.passwd_erase);
                ...
                if (!inputNum.equals(g_passwd)) {
                    ...
                    if(bChangePasswd){   //如果前面 点了修改密码
                        ...
                        if(glass_num != 0xff){
                            ...
                            intent.setClass(PasswdActivity.this, ModeSetActivity.class);
                        }
                    }
