...
//            startActivity(intent);
    ...
    private Button watch_a_graph = null;
    private Button watch_b_graph = null;
    @Override
    ...
    private void initViews() {
        ...
        watch_a_graph  = findViewById(R.id.select_a_graph);
        watch_b_graph  = findViewById(R.id.select_b_graph);
        ...
        watch_a_graph.setOnClickListener(onClickListener);
        watch_b_graph.setOnClickListener(onClickListener);
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.select_a:
                case R.id.select_a_graph:
                    glass_num = 0;
                    handler.sendEmptyMessageDelayed((0xaa00), 1);  //发送消息
                    break;

                case R.id.select_b:
                case R.id.select_b_graph:
                    glass_num = 1;
                    handler.sendEmptyMessageDelayed((0xaa00), 1);  //发送消息
                    break;
